...
const EducationItem = ({year,title,details,grade,score}) => {
  return (
    ...
    <li className='mb-10 ml-4'>  
        ...
        <p className='flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm'>
            ...
            <span className='text-lg font-semibold text-[#001b5e]'>{grade}</span>
            ...
            <span className='text-lg font-semibold text-[#001b5e]'>Score : {score}</span>
    </li>
    </ol>
  )
}
